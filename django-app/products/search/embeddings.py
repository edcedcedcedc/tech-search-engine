...
def semantic_filter_products(query_embedding, top_n=500):
    ...
    # --- Step 1: Use all products (no in-stock filtering) ---
    filtered_embeddings = embeddings_cache.PRODUCT_EMBEDDINGS
    filtered_ids = embeddings_cache.PRODUCT_IDS
    filtered_norms = embeddings_cache.EMBEDDINGS_NORM

    # --- Step 2: Compute cosine similarity ---
    sims = np.dot(filtered_embeddings, query_vec) / (filtered_norms * query_norm + 1e-8)
