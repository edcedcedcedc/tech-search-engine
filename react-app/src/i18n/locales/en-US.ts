...
Categories: "Computers • Laptops • Monitors • Graphics Cards • PC Components • Peripherals • Mobile Phones • Tablets • Gadgets • Consoles & Games • Smartwatches & Fitness Bands • Software • Photo & Video Equipment • Televisions • Office Equipment",  
 ...
 About_Us_description_secondary: `All data is taken from public sources and may be modified by stores without notice.`,
  ...
  Privacy_Intro:
    "This application is a price aggregator that displays public information retrieved from third-party online stores.",
  Privacy_DataCollection_Title: "Data collection",
  Privacy_DataCollection_Body:
    "We do not collect personally identifiable user data. The application does not require an account, authentication, or the provision of personal information.",
  Privacy_Cookies_Title: "Cookies",
  Privacy_Cookies_Body:
    "Currently, the application does not use cookies to track users. In the future, strictly necessary cookies may be used for service functionality or anonymous statistics.",
  Privacy_ExternalSources_Title: "External sources",
  Privacy_ExternalSources_Body:
    "Prices, images, and product descriptions belong to the source stores. We do not assume responsibility for the accuracy of the displayed information.",
  Privacy_Advertising_Title: "Advertising",
  Privacy_Advertising_Body:
    "The application may display advertisements through Google services. These services may use their own technologies in accordance with their privacy policies.",
